...
export default function AboutUs() {
    ...
    return (
        <div className='bg-white container mx-auto px-20 mb-40'>
            {/* Header */}
            ...
            <main className='isolate'>
                ...
                <div className='relative isolate -z-10'>
                    ...
                    <div className='overflow-hidden'>
                        <div className='  pb-32 pt-36 sm:pt-60 lg:pt-32'>
                ...
                {/* Content section */}
                <div className='mx-auto -mt-12  sm:mt-0 lg:px-8 xl:-mt-8'>
                ...
                {/* Stats */}
                <div className='mx-auto mt-32  px-6 sm:mt-40 lg:px-8'>
                    <div className='mx-auto max-w-2xl lg:mx-0'>
                        <h2 className='text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl'>
                            We approach the workplace as something that adds to
                            our lives and adds value to world.
                        </h2>
                        <p className='mt-6 text-base leading-7 text-gray-600'>
                            Diam nunc lacus lacus aliquam turpis enim. Eget hac
                            velit est euismod lacus. Est non placerat nam arcu.
                            Cras purus nibh cursus sit eu in id. Integer vel
                            nibh.
                        </p>
                    </div>
                ...
                {/* Values section */}
                <div className='mx-auto mt-32 sm:mt-40 lg:px-8'>
                ...
                {/* Blog section */}
                <div className='mx-auto mt-32px-6 sm:mt-40 lg:px-8'>
            ...
            {/* Footer */}
            {/* <footer className='mx-auto mt-40overflow-hidden pb-20 sm:mt-64 sm:pb-24 lg:px-8'>
                <nav
