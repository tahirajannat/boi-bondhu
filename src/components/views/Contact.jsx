...
export default function Contact() {
    return (
        <div className='max-w-screen-xl my-24 px-20 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg'>
                    ...
                    >
                        ...
                        <g opacity='0.1'>
                            ...
                            <path
                                ...
                                transhtmlForm='translate(-52 -162.63)'
                                fill='#3f3d56'
                            />
                            <ellipse
                                cx='479.42'
                        ...
                        <ellipse
                            ...
                            rx='1.31'
                            ry='1.75'
                            transhtmlForm='translate(-302.82 261.95) rotate(-37.22)'
                            fill='#fbbebe'
                        />
                    </svg>
                </div>
