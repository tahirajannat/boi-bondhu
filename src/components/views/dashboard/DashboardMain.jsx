...
const teams = [
    { id: 1, name: 'Chit ', href: '#', initial: 'C', current: false },
    { id: 2, name: 'Friend Lists', href: '#', initial: 'T', current: false },
];
                ...
                <Transition.Root show={sidebarOpen} as={Fragment}>
                    ...
                    >
                        ...
                        <div className='fixed inset-0 flex'>
                            ...
                            >
                                <Dialog.Panel className='relative mr-16  w-full max-w-xs'>
                                    <Transition.Child
                                        as={Fragment}
                                    ...
                                    <div className=' grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4 ring-1 ring-white/10'>
                                        ...
                                        <nav className=''>
                                            <ul
                                                role='list'
                                                className='-mx-2 space-y-1 inline-block'
                                            >
                                                {navigation.map((item) => (
                                                    <li
                                                        key={item.name}
                                            ...
                                            <li>
                                                ...
                                                <ul
                                                    role='list'
                                                    className='-mx-2 block mt-2 space-y-1'
                                                >
                                                    {teams.map((team) => (
                                                        <li
                                                            key={team.name}
                        ...
                        <nav className='text-left'>
                            <div role='list' className=''>
                                ...
                                <div>
                                    ...
                                    <ul
                                        role='list'
                                        className='-mx-2 mt-2 space-y-1 block'
                                    >
                                        {teams.map((team) => (
                                            <li
                                                key={team.name}
                            ...
                            <div className='flex items-center gap-x-4 lg:gap-x-6'>
                                ...
                                <Menu as='div' className='relative'>
                                    ...
                                    <Transition
                                        ...
                                        enterFrom='transhtmlForm opacity-0 scale-95'
                                        enterTo='transhtmlForm opacity-100 scale-100'
                                        leave='transition ease-in duration-75'
                                        leaveFrom='transhtmlForm opacity-100 scale-100'
                                        leaveTo='transhtmlForm opacity-0 scale-95'
                                    >
