...
export default function SignUp() {
    ...
    const handleSignUp = async () => {
        console.log(`💩 ~ file: SignUp.js ~ line 13 ~ `, {
            userName,
            userEmail,
            userPass,
        });
        ...
        try {
            ...
            console.log(
                `💩 ~ file: SignUp.js ~ line 22 ~ handleSignUp ~ data`,
                data
            );
            if (data) {
                toast(`${data?.message}`);
                    ...
                    <div className='justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none'>
                        <div className='relative w-auto my-6 mx-auto max-w-3xl'>
                            ...
                            <div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                                ...
                                {/*body*/}
                                <div className='bg-white p-6 md:px-12 md:pt-12 border-t-10 border-solid border-indigo-600'>
                                    <h2 className='text-3xl text-gray-800 text-center'>
                                        Create Your Account
                                    </h2>

                                    <div className='signup-htmlForm mt-6 md:mt-12'>
