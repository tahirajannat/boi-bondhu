    ...
    return (
        <header className='bg-gray-700 md:sticky top-0  border-b border-gray-900 shadow-lg transition-shadow font-serif z-20'>
            <div className='container mx-auto md:px-20 px-10 py-2 grid grid-cols-12'>
                    ...
                    <htmlForm>
                        <div className='flex'>
                            ...
                            <button
                                ...
                                className='flex-shrink-0 z-10 inline-flex items-center py-2 px-4 text-sm font-medium text-center text-gray-500 bg-gray-100 border border-gray-300 rounded-l-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600'
                                type='button'
                            >
                                <svg
                                    aria-hidden='true'
              ...
              // style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transhtmlForm: translate(0px, 72px);"
              ...
              ></ul>
                            ...
                            <div className='relative w-full'>
                                <input
                                    type='search'
                                    id='location-search"'
                                    className='block p-2 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-md border-l-gray-50 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-yellow-600 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500 focus:outline-none'
                                    placeholder='Search htmlFor city or address'
                                    required=''
                                />
                                <button
                                    type='submit'
                                    className='absolute top-0 right-0 p-2 text-sm font-medium text-white bg-yellow-600 rounded-r-md border border-yellow-600 hover:bg-yellow-700 focus:ring-4 focus:outline-none active:outline-none'
                                >
                                    <svg
                                        aria-hidden='true'
                                        className='w-5 h-5'
